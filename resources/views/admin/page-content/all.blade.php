                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->pc_photo!='')
                                                <img class="table_image_ban" src="{{asset('public/uploads/page-content/'.$data->pc_photo)}}" alt="photo"/>
                                            @else
                                                <img class="table_image_ban" src="{{asset('public/uploads')}}/no-image-big.jpg" alt="photo"/>
                                            @endif
                                        </td>
                                        <td>
