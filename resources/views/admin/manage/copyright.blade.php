...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/manage/copyright/update')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="copyright" value="{{$data->copy_title}}">
                    </div>
                </div>

                <div class="form-group row custom_form_group">
                    <label class="col-sm-3 control-label">Creator Name:</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="creator" value="{{$data->copy_creator}}">
                    </div>
                </div>
              </div>
