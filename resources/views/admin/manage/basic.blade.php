          ...
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-2">
                        <img class="img-thumbnail" src="{{ asset('public/uploads/basic/'.$basic->basic_logo) }}"/>
                    </div>
                </div>
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-2">
                        <img class="img-thumbnail basic_favicon_img" src="{{ asset('public/uploads/basic/'.$basic->basic_favicon) }}"/>
                    </div>
                </div>
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-2">
                        <img class="img-thumbnail" src="{{ asset('public/uploads/basic/'.$basic->basic_flogo) }}"/>
                    </div>
                </div>
              </div>
