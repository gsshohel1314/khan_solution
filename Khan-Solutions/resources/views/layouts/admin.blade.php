...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
      ...
      {{-- <link href="{{asset('public/contents/admin')}}/assets/timepicker/bootstrap-timepicker.min.css" rel="stylesheet" type="text/css" /> --}}
      {{-- <link href="{{asset('public/contents/admin')}}/assets/timepicker/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css" /> --}}
  </head>
  <body class="fixed-left">
                  ...
                  <div class="container-fluid">
                      ...
                      <ul class="nav navbar-right float-right list-inline">
                          ...
                          <li class="dropdown open">
                              <a href="#" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{asset('public/uploads/users/'.Auth::user()->photo)}}" alt="user-img" class="rounded-circle"> </a>
          ...
          <div class="left side-menu">
              <div class="sidebar-inner slimscrollleft">
                  <div class="user-details">
                      <div class="pull-left">
                          <img src="{{asset('public/uploads/users/'.Auth::user()->photo)}}" alt="" class="thumb-md rounded-circle">
                      </div>
                      <div class="user-info">
                          <div class="dropdown">
                  ...
                  <div id="sidebar-menu">
                      <ul>
                          ...
                          @endif
                          <li><a href="{{url('dashboard/service')}}" class="waves-effect"><i class="md md-account-box"></i><span>Services </span></a></li>

                          <li class="has_sub">
                            <a href="#" class="waves-effect"><i class="md md-view-quilt"></i><span>Project </span><span class="pull-right"><i class="md md-add"></i></span></a>
                            <ul class="list-unstyled">
      ...
      {{-- <script src="{{asset('public/contents/admin')}}/assets/js/bootstrap.js"></script> --}}
      ...
      {{-- <script src="{{asset('public/contents/admin')}}/assets/timepicker/bootstrap-timepicker.min.js"></script> --}}
      {{-- <script src="{{asset('public/contents/admin')}}/assets/timepicker/bootstrap-datepicker.js"></script> --}}
