                    ...
                    <div class="col-md-8">
                        <table class="table table-bordered table-striped table-hover custom_view_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->post_photo!='')
                                        <img class="table_image_200" src="{{asset('public/uploads/post/'.$data->post_photo)}}" alt="post"/>
                                    @else
                                        <img class="table_image_200" src="{{asset('public/uploads')}}/no-image-big.jpg" alt="post"/>
                                    @endif
                                </td>
                            </tr>
                            <tr>
