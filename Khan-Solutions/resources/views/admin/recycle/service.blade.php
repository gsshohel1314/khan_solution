                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    @foreach($allRecycleService as $data)
                                    <tr>
                                        <td>{{$data->name}}</td>
                                        <td>{{$data->details}}</td>
                                        <td>{{$data->icon}}</td>
                                        ...
                                        <td>
                                            <a class="servicerestore" data-servicerestore="{{ url('dashboard/recycle/service/restore/'.$data->id) }}" data-toggle="modal" data-target="#exampleModalRestore"><i class="fa fa-recycle text-success fa-lg"></i></a>

                                            <a class="serviceharddelete" data-serviceharddelete="{{url('dashboard/recycle/service/delete/'.$data->id)}}" data-toggle="modal" data-target="#exampleModalDelete"><i class="fa fa-trash text-danger fa-lg"></i></a>
...
<div id="exampleModalRestore" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="" id="servicerestore"/>
              @csrf
              @method('get')
              <div class="card mb-0">
                <div class="card-header">
...
<div id="exampleModalDelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="" id="serviceharddelete"/>
              @csrf
              @method('delete')
              <div class="card mb-0">
                <div class="card-header">
