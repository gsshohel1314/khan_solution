                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->team_photo!='')
                                                <img class="table_image_50bl" src="{{asset('public/uploads/team/'.$data->team_photo)}}" alt="image"/>
                                            @else
                                        ...
                                        <td>
                                            ...
                                            <a class="team_delete" data-team_delete="{{url('dashboard/team/delete/'.$data->team_id)}}" data-toggle="modal" data-target="#exampleModalDelete"><i class="fa fa-trash text-danger fa-lg"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<div id="exampleModalDelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="" id="team_delete"/>
              @csrf
              @method('delete')
              <div class="card mb-0">
                <div class="card-header">
